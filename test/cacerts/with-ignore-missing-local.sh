...
# The feature was installed with a nonexistent local path and ignoreMissing=true.
...
# Check that the nonexistent local cert was NOT installed
check "missing-local-cert-not-installed" bash -c "! test -f /usr/local/share/ca-certificates/fake-ca.crt"
